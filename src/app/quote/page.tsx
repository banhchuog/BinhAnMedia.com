...
const DEFAULT_SERVICE_OPTIONS: ServiceDef[] = [
  ...
  { id: "mini_tvc", label: "Mini TVC", svgIcon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polygon points="10 8 16 12 10 16 10 8"/></svg>`, desc: "Quảng cáo 15-30s, sản phẩm, F&B", qualityRef: "1 ngày quay, ekip gọn 4-5 người, studio nhỏ", refVideoUrl: "" },
  { id: "micro_tvc", label: "Micro TVC", svgIcon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M10 8v8l6-4-6-4Z"/></svg>`, desc: "Clip 6-15s, nhanh gọn cho digital", qualityRef: "Nửa ngày quay, ekip 2-3 người, biên tập trong ngày", refVideoUrl: "" },
...
function QuoteBuilder() {
  ...
  const submitToApi = () => fetch("/api/quote/submit", {
    method: "POST",
