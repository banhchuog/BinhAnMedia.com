    ...
    <div className="min-h-screen soft-page flex items-center justify-center px-5 pt-20 pb-32">
      <div className="max-w-md w-full text-center soft-card rounded-[2rem] p-6 sm:p-8">
        ...
        <p className="text-[#6F746A] text-base leading-relaxed mb-8">
          ...
          Chúng tôi sẽ xem xét hồ sơ và phản hồi qua <strong className="text-[#1F241E]">Zalo</strong> trong vòng <strong className="text-[#1F241E]">1–2 ngày</strong>.
        </p>

        <div className="bg-white/60 border border-black/8 rounded-2xl p-5 mb-8 text-left">
          <p className="text-[#8A8F83] text-xs uppercase tracking-widest mb-3">Các bước tiếp theo</p>
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <p className="text-[#5D6359] text-sm">Công ty xem hồ sơ & showreel của bạn</p>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 rounded-full bg-[#C9972A]/15 flex items-center justify-center flex-shrink-0 mt-0.5">
                <span className="text-[#C9972A] text-xs font-bold">2</span>
              </div>
              <p className="text-[#5D6359] text-sm">Nếu phù hợp, nhắn tin qua Zalo để xác nhận lịch phỏng vấn</p>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 rounded-full bg-[#C9972A]/15 flex items-center justify-center flex-shrink-0 mt-0.5">
                <span className="text-[#C9972A] text-xs font-bold">3</span>
              </div>
              <p className="text-[#5D6359] text-sm">Phỏng vấn online qua Zalo video call</p>
            </div>
          </div>
        </div>

        <div className="bg-white/60 border border-black/8 rounded-2xl p-5 mb-8 text-left">
          <p className="text-[#8A8F83] text-xs uppercase tracking-widest mb-3">Lưu ý</p>
          <div className="flex items-start gap-3">
            <MessageCircle size={16} className="text-[#C9972A] flex-shrink-0 mt-0.5" />
            <p className="text-[#6F746A] text-sm leading-relaxed">
              Hãy đảm bảo <strong className="text-[#1F241E]">Zalo</strong> của bạn đang hoạt động với số điện thoại đã đăng ký để công ty có thể liên hệ.
            </p>
          </div>
        </div>
